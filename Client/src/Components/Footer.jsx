            ...
            <Container className='border border-2 border-secondary shadow-top'>
                <Row>
                    ...
                    <Nav className='d-flex flex-column mx-auto align-items-center'>
                        ...
                        <Nav.Link href="/Politique-confidentialite">Politique de Confidentialité</Nav.Link>
                        <Nav.Link href="/Accessibilité">Accessibilité</Nav.Link>
                        <Nav.Link href="/Politique-cookies">Politique de Cookies</Nav.Link> 
                    </Nav>
                    </Col>
